        ...
        <div id="wrapper">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 15%;"><input type="checkbox" name="valUseDate" id="valUseDate" value="valUseDate" style="margin-left:"></td>
                    <td style="width: 35%;">
                </tr>
                <tr>
                    <td style="padding-top: 10px; text-align: right;"><label for="valStartDate">Start Date:&nbsp;</label></td>
                    <td style="padding-top: 10px;"><input type="text" name="valStartDate" id="valStartDate" value="<?php echo $valStartDate; ?>" maxlength="10" style="width: 100px; text-align: right;"></td>
                ...
                <tr>
                    ...
                    <td style="padding-top: 10px;"><input type="text" name="valEndDate" id="valEndDate" value="<?php echo $valEndDate; ?>" maxlength="10" style="width: 100px; text-align: right;"></td>
                ...
                <tr>
                    ...
                    <td style="padding-top: 10px;"><input type="checkbox" name="valUseAcc" id="valUseAcc" value="valUseAcc" style="margin-left:"></td>
                    <td style="padding-top: 10px;">
                </tr>
                <tr>
                    <td style="padding-top: 10px; text-align: right;"><label for="valAccNum">Account Number:&nbsp;</label></td>
                    <td style="padding-top: 10px;"><input type="text" name="valAccNum" id="valAccNum" value="<?php echo $valAccNum; ?>" maxlength="10" style="width: 100px; text-align: right;"></td>
